...
_Если быть честными до конца, для решения задачи хватит проверки чисел до квадратного корня из `number`. Но здесь важно сосредоточиться на работе с условием внутри цикла_
