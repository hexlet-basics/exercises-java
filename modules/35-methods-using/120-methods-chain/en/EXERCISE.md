...
Write code that takes data from the `name` variable and performs capitalization. In programming, this is the name for the operation that makes the first letter of a word uppercase and converts all the others to lowercase. For example: _heXlet => Hexlet_. The program should print the result to the screen.
