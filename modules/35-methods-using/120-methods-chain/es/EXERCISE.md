...
Escribe un código que tome los datos de la variable `name` y realice la capitalización. En programación, así se llama la operación que pone en mayúscula la primera letra de una palabra y convierte todas las demás a minúsculas. Por ejemplo: *heXlet => Hexlet*. El programa debe mostrar el resultado en pantalla.
