...
Линтер только сообщает о нарушении. Для исправления кода используют форматтеры, программы, которые приводят код к стандарту сами.

В Java форматирование подключают плагином [spotless](https://github.com/diffplug/spotless). Сам формат задаёт [google-java-format](https://github.com/google/google-java-format), стандарт оформления от Google. Одна команда, и весь код проекта выглядит единообразно, поэтому спорить о расстановке пробелов и переносов в команде не приходится.

Помните, что наличие линтера не отменяет самостоятельного анализа и упрощения чтения кода. В проектах на [Хекслете](https://ru.hexlet.io/?utm_source=code-basics&utm_medium=referral&utm_campaign=programs&utm_content=lesson) и в реальной разработке проверка стиля встроена в сборку, и код с нарушениями до ревью не доезжает.
